...
function more_close() {
	seeMoreBody.classList.remove("_active");
	moreBlock.classList.remove("_active");
}
...
spollersInist()
window.addEventListener('resize', spollersInist)
...
let sliderHome = new Swiper('.slider__row', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
